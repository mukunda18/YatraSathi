...
export const initDb = async () => {
    ...
    const sql = `
            ...
            CREATE TABLE IF NOT EXISTS users (
                ...
                avg_rating NUMERIC(3,2) DEFAULT 5.0 CHECK (avg_rating BETWEEN 0 AND 5),
            ...
            BEGIN
                ...
                END IF;
                IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_ride_requests_updated_at') THEN
                    CREATE TRIGGER update_ride_requests_updated_at BEFORE UPDATE ON ride_requests FOR EACH ROW EXECUTE PROCEDURE update_updated_at_column();
                END IF;
            END $$;
        `;
    ...
    try {
        ...
        if (typeof error === "object" && error !== null && "code" in error && error.code === "40P01") {
            console.warn("Database initialization deadlock detected (concurrent processes), skipping...");
        } else {
